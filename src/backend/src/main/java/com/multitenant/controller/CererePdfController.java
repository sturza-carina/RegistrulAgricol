...
public class CererePdfController {
    ...
    public CererePdfController(CerereRepository cerereRepository, PdfGeneratorService pdfGeneratorService, PublicUatRepository publicUatRepository) {
    ...
    public ResponseEntity<byte[]> downloadCererePdf(@PathVariable Long id) {
        ...
        if (isAdmin) {
            ...
            // Ensure tenant context is still cleared after search
            TenantContext.clear();
        }
