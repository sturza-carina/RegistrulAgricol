...
@Setter
@NoArgsConstructor
@SQLDelete(sql = "UPDATE animale_individuale SET deleted = true WHERE id=?")
...
public class AnimalIndividual {
    ...
    // SNIIA: Codul de crotaliere (ear-tag) este unic per fermÄƒ È™i global Ã®n registrul naÈ›ional.
    ...
    private String numarCrotal; // nullable â€” animals may lack a tag at birth (ANSVSA allows it)
    ...
    /**
     * Lista evenimentelor Ã®nregistrate pentru acest animal.
     * @JsonIgnore previne recursivitatea infinitÄƒ la serializare.
     * FolosiÈ›i EvenimentAnimalRepository pentru a accesa timeline-ul.
     */
