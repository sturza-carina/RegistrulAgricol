CREATE TABLE IF NOT EXISTS contract_utilizare (
    ...
    locator_proprietar_id INT REFERENCES persons(id) ON DELETE SET NULL,
    locator_utilizator_id INT REFERENCES persons(id) ON DELETE SET NULL,
    ...
    status_contract VARCHAR(50) DEFAULT 'ACTIV',
    motiv_incetare TEXT,
    data_operare DATE DEFAULT CURRENT_DATE,
    utilizator_operare_id INT REFERENCES persons(id) ON DELETE SET NULL,
