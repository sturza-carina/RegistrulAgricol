...
export class AppTranslatePipe implements PipeTransform {
  ...
  private dictionary: { [key: string]: string } = {
    ...
    // Statistical Centralizer Translations
    'Centralizatoare Statistice': $localize`:@@dict_stat_centralizers:Centralizatoare Statistice`,
    'Centralizatoare Statistice (DAJ / INS)': $localize`:@@dict_stat_centralizers_title:Centralizatoare Statistice (DAJ / INS)`,
    'Rapoarte centralizate privind exploatațiile vegetale, zootehnice și utilajele agricole din UAT.': $localize`:@@dict_stat_centralizers_desc:Rapoarte centralizate privind exploatațiile vegetale, zootehnice și utilajele agricole din UAT.`,
    'An Raportare': $localize`:@@dict_reporting_year:An Raportare`,
    'Se încarcă datele statistice...': $localize`:@@dict_loading_stats:Se încarcă datele statistice...`,
    'Sector Vegetal': $localize`:@@dict_vegetal_sector:Sector Vegetal`,
    'Sector Zootehnic': $localize`:@@dict_livestock_sector:Sector Zootehnic`,
    'Mijloace Transport / Utilaje': $localize`:@@dict_machinery_transport:Mijloace Transport / Utilaje`,
    'culturi înregistrate': $localize`:@@dict_registered_crops_plural:culturi înregistrate`,
    'Capete': $localize`:@@dict_heads:Capete`,
    'individuale': $localize`:@@dict_individual_plural:individuale`,
    'de grup': $localize`:@@dict_group_plural:de grup`,
    'Unități': $localize`:@@dict_units:Unități`,
    'Utilaje și mașini agricole înregistrate': $localize`:@@dict_registered_machinery_desc:Utilaje și mașini agricole înregistrate`,
    'Centralizator Vegetal': $localize`:@@dict_vegetal_centralizer:Centralizator Vegetal`,
    'Centralizator Zootehnic': $localize`:@@dict_livestock_centralizer:Centralizator Zootehnic`,
    'Centralizator Utilaje': $localize`:@@dict_machinery_centralizer:Centralizator Utilaje`,
    'Centralizator Culturi Agricole și Categoriilor de Folosință': $localize`:@@dict_vegetal_centralizer_title:Centralizator Culturi Agricole și Categoriilor de Folosință`,
    'Date agregate privind suprafețele cultivate și tipul terenurilor pentru anul': $localize`:@@dict_vegetal_centralizer_desc:Date agregate privind suprafețele cultivate și tipul terenurilor pentru anul`,
    'Exportă Raport Excel (CSV)': $localize`:@@dict_export_excel_csv:Exportă Raport Excel (CSV)`,
    'Suprafețe Cultivate': $localize`:@@dict_cultivated_areas:Suprafețe Cultivate`,
    'Specie Cultură / Plantă': $localize`:@@dict_crop_species:Specie Cultură / Plantă`,
    'Producție Totală Estimată (t)': $localize`:@@dict_total_production_t:Producție Totală Estimată (t)`,
    'Nicio cultură înregistrată pentru acest an.': $localize`:@@dict_no_crops_year:Nicio cultură înregistrată pentru acest an.`,
    'Categorii de Folosință Teren': $localize`:@@dict_land_use_categories:Categorii de Folosință Teren`,
    'Categorie de Folosință': $localize`:@@dict_land_use_category:Categorie de Folosință`,
    'Nicio categorie de folosință înregistrată.': $localize`:@@dict_no_land_use_registered:Nicio categorie de folosință înregistrată.`,
    'Centralizator Efective de Animale': $localize`:@@dict_livestock_centralizer_title:Centralizator Efective de Animale`,
    'Situația consolidată a efectivelor zootehnice (animale identificate individual și în grup).': $localize`:@@dict_livestock_centralizer_desc:Situația consolidată a efectivelor zootehnice (animale identificate individual și în grup).`,
    'Animale Identificate Individual (Crotalate)': $localize`:@@dict_individually_identified_animals:Animale Identificate Individual (Crotalate)`,
    'Specie Animal': $localize`:@@dict_animal_species:Specie Animal`,
    'Total Capete': $localize`:@@dict_total_heads:Total Capete`,
    'Masculi': $localize`:@@dict_males:Masculi`,
    'Femele': $localize`:@@dict_females:Femele`,
    'Niciun animal identificat individual înregistrat.': $localize`:@@dict_no_individual_animals_registered:Niciun animal identificat individual înregistrat.`,
    'Efective de Grup (Pasări, Apicole etc.)': $localize`:@@dict_group_livestock:Efective de Grup (Pasări, Apicole etc.)`,
    'Specie / Categorie Grup': $localize`:@@dict_group_species:Specie / Categorie Grup`,
    'Total Capete / Familii': $localize`:@@dict_total_heads_families:Total Capete / Familii`,
    'Niciun efectiv de grup înregistrat.': $localize`:@@dict_no_group_livestock_registered:Niciun efectiv de grup înregistrat.`,
    'Centralizator Mașini și Utilaje Agricole': $localize`:@@dict_machinery_centralizer_title:Centralizator Mașini și Utilaje Agricole`,
    'Inventarul complet al utilajelor, tractoarelor și mijloacelor de transport înregistrate în UAT.': $localize`:@@dict_machinery_centralizer_desc:Inventarul complet al utilajelor, tractoarelor și mijloacelor de transport înregistrate în UAT.`,
